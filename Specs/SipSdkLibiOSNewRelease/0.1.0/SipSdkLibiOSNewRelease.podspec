Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://s3.amazonaws.com/yallo-sipsdk/new_38/libSipSdkLib.a.zip" }

  s.source_files = 'SipSdkLib/*.h'

  s.vendored_library   = 'release/libSipSdkLib.a'

  s.xcconfig  =  { :LIBRARY_SEARCH_PATHS => '"$(PODS_ROOT)/SipiOSRelease/"'}

  s.dependency 'YalloThirdPartyLibsRelease', '~>1.1.0'
end
