...
Pod::Spec.new do |s|
	...
	s.source           	= {:git => "https://github.com/Secure-Connection/VialerSIPLib-private.git", :tag => s.version.to_s}
    ...
    s.dependency 'Vialer-pjsip-iOS', '3.1.0'
