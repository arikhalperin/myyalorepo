...
DESC
  ...
  s.authors      = { "iziz" => "zen.isis@gmail.com", "hyukhur" => "hyukhur@gmail.com", "yosit" => "yosi@taguri.com" }
  s.source       = { :git => "https://github.com/yosit/libPhoneNumber-iOS.git", :commit => "394afb9ccbf0544fcd622db9a2fd4b517fac1e07" }
  s.platform     = :ios, '4.3'
