Pod::Spec.new do |s|
  ...
  s.source       = { :git => "ssh://git@github.com/yaloapp/yalo-sip.git",:tag => '0.1.5'}
  s.platform     = :ios, '4.3'
  s.requires_arc = true 
  s.source_files = 'webrtc-adapter/*.h'
  s.preserve_paths = 'webrtc-adapter', 'pjsip-ios/release','pjsip-ios/headers/**/*.h','pjsip-ios/headers/pjlib/include/pj/compat/os_auto.h'
